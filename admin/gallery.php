...
if(isset($_GET['delsr_no'])){
    ...
    $sql=mysqli_query($conn,"delete from gallery where id='$sr_no'");
    if($sql=1){
...
if(isset($_POST['submit']))
{
  ...
  $name = $_POST['name'];
    ...
    $sql="INSERT INTO `gallery`(`name`, `image`, `subject`) VALUES ('$name','$image','$subject')";
...
$dnk=$_FILES['image']['tmp_name'];
  ...
  $sql="UPDATE `gallery` SET `name`='$name',`image`='$image',`subject`='$subject' WHERE id='$id'";
  if (mysqli_query($conn, $sql)){
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    ?>
                  ...
                  <a href="gallery.php?delsr_no=<?php echo $arr['id']; ?>"><button type="button"
