        ...
        <div class="site-wrapper">
            ...
            <section class="section-side-image clearfix">
                <div class="img-holder col-md-12 col-sm-12 col-xs-12">
                    <div class="background-imgholder" style="background:url(images/img/aboutus4.jpg);">
            ...
            <!--end header inner-->
            <section class="sec-padding mt-5 pt-5">
                <div class="container">
                    <div class="row">
            ...
            <section class="sec-padding">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <p class="para"> Capacitance Impulse technology
                                releases...programmed complexed Modulating
                            ...
                            <p class="para"> <b> The capacitance Impulse frequency
                                </b>Efficiently charge & prevent
                        ...
                        <div class="col-md-12">
                            <p class="para">    
                                ...
                                Advanced <b>capacitance impulse technology 4 stage model</b>
                            </p>
                        </div>
                        <!--end item-->
                    </div>
            ...
            <!--end item-->
            <section class="sec-padding my-5 py-5">
                <div class="container">
                    <h3 class="uppercase font-weight-7 text-gyellow">We are 1<sup>st</sup> choice because our
                        technology
                    ...
                    <div class="row mt-5 pt-5">
						...
						<div class="col-md-6">
                            <img src="images/img.webp" class="img-responsive">
                        </div>
            ...
            <section class="sec-padding  my-5 py-5">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="uppercase font-weight-7 text-gyellow col-centered text-center">
                                WHY
                                SUDARSHAN ??</h3>
								<div class="tp-title-line-2"></div>
                            <div class="line para">
                                ...
                                <p><b>💧 Our impulse technology have
                                        ( TWO WAY)
                                        DOUBLE EXCITATION strong frequency wave flow for excellent performance
                                        shown in GIF</b></p>
                        ...
                        <!--end item-->
                        <div class="row">
                            <div class="col-md-8 margin-bottom  col-centered">

                                <div style="margin: 0% 0px 0px;" class="col-md-12 col-sm-12 col-xs-12 margin-bottom">
                                    <video width="100%" height="200" src="images/sliders/video.mp4" type="video/mp4"
                                        frameborder="0" controls=""></video>
