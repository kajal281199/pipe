        ...
        <div class="site-wrapper">
            ...
            <section class="section-side-image clearfix">
                <div class="img-holder col-md-12 col-sm-12 col-xs-12">
                    <div class="background-imgholder" style="background:url(images/bg/animal.webp);"><img
                            ...
                            <div class="header-inner less-height">
                                <div class="overlay">
                                    <div class="text text-center">
                                        <h3 class="uppercase text-white less-mar-1 title" style=" color: white;">Other
                                            Applications</h3>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="my-5 py-5">
                <h3 class="uppercase font-weight-7 text-gyellow text-center">Impulse Technology for
                    Poultry and
                    Animal Trading</h3>
                <div class="tp-title-line-2"></div>
                <div class="container">
                    <div class="row para mt-5">
                        <div class="col-md-4 col-lg-5 col-sm-12">
                            <img src="images/pages/other1.webp" class="img-responsive">
                        </div>
                        <div class="col-md-8 col-lg-7 col-sm-12 para">
                            <p>After long observation and research by the
                                scientists of impulse technology companies all over the world it is noted that
                                using, treated water for drinking purpose of chicks and animals results:</p>
                            <p>💧 Increase in the process of bone formation.</p>
                            <p>💧 Improves morphology of blood.</p>
                            <p>💧 Helpful in the growth and development of some
                                bones.</p>
                            <p>💧 Quality and quantity of meat improves</p>
                            <p>💧 Reduction in death rates by 2-3 times also noted.
                            </p>
                            <p>💧 Average weight gain increse by 5 - 7% with egg
                                laying quality by 10%.</p>
                            <!--end item-->
                        </div>
                    </div>
                </div>
            ...
            <section class="sec-bpadding-1 sec-padding">
                <div class="container">
                    <h3 class="uppercase font-weight-7 text-gyellow text-center">Impulse Technology for Concrete and
                        Cement Industry</h3>
                    <div class="tp-title-line-2"></div>
                    <div class="row para">
                        ...
                        <div class="col-md-8 col-lg-7 col-sm-12 para">
                            ...
                            <p>💧 Decrease in the volume of water become quite
                                possible.</p>
                            <p>💧 The most important advantage : it increases the
                                compressive strength of cement up to 27%.</p>
                            <p>💧 Concrete made in this way is more resistance
                                against freezing and more impermeable.</p>
                            <p>💧 Decrease in rate of breakage and wastage up to
                                25%.</p>
                            <p>💧 Decrease in water surface tension in magnetic
                                water by 10% in comparison with ordunary water.</p>
                            <p>💧 This device can be used and benefited any cement industry such as :</p>
                            <p>a) Paver Block Mfrs.</p>
                            <p>b) Cement Block Mfrs.</p>
                            <p>c) Cement Roof,Tops ,Sheets Mrfs.</p>
                            <p>d) Ready Mix Cement Plant and all types of
                                Construction Industries who are using cement.</p>

                            <!--end item-->
                        </div>
                        <div class="col-md-4 col-lg-5 col-sm-12">
                            <img src="images/pages/other2.webp" class="img-responsive">
                        </div>
                    </div>
                </div>
            </section>
